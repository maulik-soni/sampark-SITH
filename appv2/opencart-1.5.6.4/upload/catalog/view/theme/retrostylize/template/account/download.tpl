  ...
  <div class="download-list">
    ...
    <div class="download-content">
      ...
      <div class="download-info">
        ...
        <a href="<?php echo $download['href']; ?>"><img src="catalog/view/theme/retrostylize/image/download.png" alt="<?php echo $button_download; ?>" title="<?php echo $button_download; ?>" /></a>
        <?php } ?>
      </div>
    </div>
  </div>
